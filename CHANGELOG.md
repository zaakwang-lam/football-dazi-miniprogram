...
- ♻️ **AppID 更新为** `wx08b512fda8bed423`（`project.config.json` + `app.js` `globalData.wxAppId`），原 `wxb3f1e355853399c8` [2026-09-20]
...
_最后更新: 2026-09-20 · AppID 更新为 wx08b512fda8bed423_
